...
var filename = "updates/" + uuid.v1() + ".zip";
var url = "https://github.com/CraigLager/express-boilerplate/archive/master.zip";

console.log("downloading to " + filename);
getFile(url,filename,function(){console.log("downloaded");});
